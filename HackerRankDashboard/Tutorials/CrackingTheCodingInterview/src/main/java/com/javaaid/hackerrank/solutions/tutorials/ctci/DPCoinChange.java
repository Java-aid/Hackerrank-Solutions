...
//	        approach4(n, coins);
	...
	private static long noOfWaysToGetChangeUsingRecusion(int[] coins, int n,int index) {
		...
		return noOfWaysToGetChangeUsingRecusion(coins, n-coins[index], index)+noOfWaysToGetChangeUsingRecusion(coins, n, index+1);
	}
	...
	private static long noOfWaysToGetChangeUsingRecursionWithMemo(int[] coins, int n,int index,long [][]memo) {
		...
		return memo[n][index]=noOfWaysToGetChangeUsingRecursionWithMemo(coins, n-coins[index], index,memo)+noOfWaysToGetChangeUsingRecursionWithMemo(coins, n, index+1,memo);
	}
